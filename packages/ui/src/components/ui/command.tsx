...
>(({ className, ...props }, ref) => (
  <div className="pd-flex pd-items-center pd-border-b pd-px-3" cmdk-input-wrapper="">
    <Search className="pd-mr-2 pd-h-4 pd-w-4 pd-shrink-0 pd-opacity-50" />
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.List
    ref={ref}
    className={cn("pd-max-h-[300px] pd-overflow-y-auto pd-overflow-x-hidden", className)}
    {...props}
  />
))
...
>((props, ref) => (
  <CommandPrimitive.Empty
    ref={ref}
    className="pd-py-6 pd-text-center pd-text-sm"
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Separator
    ref={ref}
    className={cn("pd--mx-1 pd-h-px pd-bg-border", className)}
    {...props}
  />
))
