...
function useCarousel() {
  ...
  if (!context) {
    throw new Error("pd-useCarousel pd-must pd-be pd-used pd-within pd-a pd-<Carousel pd-/>")
  }
  ...
  return (
    <div ref={carouselRef} className="pd-overflow-hidden">
      <div
        ...
        className={cn(
          "pd-flex",
          orientation === "horizontal" ? "-ml-4" : "pd--mt-4 pd-flex-col",
          className
        )}
        {...props}
      />
...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "pd-absolute pd-size-8 pd-rounded-full",
        orientation === "horizontal"
      ...
      {...props}
    >
      <ArrowLeft className="pd-h-4 pd-w-4" />
...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <ArrowRight className="pd-h-4 pd-w-4" />
